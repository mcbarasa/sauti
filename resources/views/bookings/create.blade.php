    ...
    <div class="booking-wrap reveal">
      ...
      <div class="booking-info">
        ...
        <div style="margin-top:2rem;padding-top:1.5rem;border-top:1px solid var(--hours-border);">
          ...
          <ul class="hours-list">
            <li>Rehearsal Room (2hr block) <span>KES 1,000</span></li>
            <li>Recording Suite (per hour) <span>KES 2,000</span></li>
...
@endif
        ...
        <form id="bookingForm" action="{{ route('bookings.initiate') }}" method="POST" novalidate>
          ...
          <div class="form-group">
            ...
            <input type="tel" maxlength="15" name="phone" placeholder="+254 7XX XXX XXX" value="{{ old('phone') }}" />
